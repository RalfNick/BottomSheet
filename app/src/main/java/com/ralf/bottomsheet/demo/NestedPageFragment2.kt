...
class NestedPageFragment2 : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_page_nested_2, container, false)
    }

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        view.findViewById<View>(R.id.back).setOnClickListener {
            (parentFragment as? BottomSheetNestedFragment)?.removeChildFragment("NestedPageFragment2")
        }
